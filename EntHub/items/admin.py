...
admin.site.register(models.BookMarkLog)
admin.site.register(models.MovieMarkLog)
admin.site.register(models.SeriesMarkLog)
admin.site.register(models.ComicMarkLog)
admin.site.register(models.ComicSeriesMarkLog)
admin.site.register(models.GameMarkLog)
admin.site.register(models.DLCMarkLog)